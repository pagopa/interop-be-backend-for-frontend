...
object PagopaVersions {
  ...
  lazy val selfcarePartyProcessClientVersion    = "0.1.x-SNAPSHOT"
  lazy val selfcarePartyManagementClientVersion = "0.1.x-SNAPSHOT"
  lazy val selfcareUserRegistryVersion          = "0.1.x-SNAPSHOT"
