...
object PagopaVersions {
  ...
  lazy val partyProcessVersion                = "1.0.5"
  lazy val partyManagementVersion             = "1.0.5"
  ...
  lazy val authorizationProcessVersion        = "1.0.9"
  lazy val selfcareV2ClientVersion            = "1.0.5"
}