...
object PagopaVersions {
  ...
  lazy val agreementProcessVersion            = "1.0.10"
  lazy val catalogManagementVersion           = "1.0.12"
  lazy val catalogProcessVersion              = "1.0.9"
  lazy val partyProcessVersion                = "1.0.6"
  lazy val partyManagementVersion             = "1.0.6"
  lazy val tenantManagementVersion            = "1.0.6"
  lazy val tenantProcessVersion               = "1.0.6"
  lazy val purposeProcessVersion              = "1.0.10"
  lazy val userRegistryVersion                = "1.0.5"
  lazy val attributeRegistryProcessVersion    = "1.0.0"
  lazy val attributeRegistryManagementVersion = "1.0.10"
  lazy val authorizationProcessVersion        = "1.0.10"
  lazy val selfcareV2ClientVersion            = "1.0.6"
}