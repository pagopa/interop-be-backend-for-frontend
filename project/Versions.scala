...
object PagopaVersions {
  ...
  lazy val catalogProcessVersion              = "1.0.10"
  lazy val partyProcessVersion                = "1.0.7"
  lazy val partyManagementVersion             = "1.0.7"
  lazy val tenantManagementVersion            = "1.0.7"
  lazy val tenantProcessVersion               = "1.0.8"
  lazy val purposeProcessVersion              = "1.0.11"
  lazy val userRegistryVersion                = "1.0.7"
  ...
  lazy val authorizationServerVersion         = "1.0.10"
  lazy val authorizationProcessVersion        = "1.0.11"
