...
object PagopaVersions {
  ...
  lazy val agreementProcessVersion  = "1.0.7"
  lazy val catalogManagementVersion = "1.0.9"
  lazy val catalogProcessVersion    = "1.0.6"
  lazy val partyProcessVersion      = "1.0.2"
  lazy val partyManagementVersion   = "1.0.2"
  lazy val tenantManagementVersion  = "1.0.3"
  lazy val tenantProcessVersion     = "1.0.2"
  lazy val userRegistryVersion      = "1.0.2"
  lazy val attributeRegistryVersion = "1.0.7"
}
