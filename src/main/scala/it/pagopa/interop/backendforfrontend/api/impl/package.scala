...
package object impl extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val certifiedTenantAttributeSeedFormat: RootJsonFormat[CertifiedTenantAttributeSeed] = jsonFormat1(
  ...
  implicit val compactPurposeEServiceFormat: RootJsonFormat[CompactPurposeEService] = jsonFormat5(
  ...
  implicit val requesterCertifiedAttributeFormat: RootJsonFormat[RequesterCertifiedAttribute]   =
    jsonFormat4(RequesterCertifiedAttribute)
  implicit val requesterCertifiedAttributesFormat: RootJsonFormat[RequesterCertifiedAttributes] =
    jsonFormat2(RequesterCertifiedAttributes)
  ...
  implicit val certifiedAttributeSeedFormat: RootJsonFormat[CertifiedAttributeSeed] = jsonFormat2(
  ...
  implicit val updateEServicePublishedDescriptorSeed: RootJsonFormat[UpdateEServicePublishedDescriptorSeed] =
