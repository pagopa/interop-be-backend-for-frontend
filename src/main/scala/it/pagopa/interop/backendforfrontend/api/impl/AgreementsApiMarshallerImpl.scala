...
object AgreementsApiMarshallerImpl extends AgreementsApiMarshaller with SprayJsonSupport with DefaultJsonProtocol {
  ...
  override implicit def toEntityMarshallerCompactAgreementEServices: ToEntityMarshaller[CompactAgreementEServices] =
    sprayJsonMarshaller[CompactAgreementEServices]
}
