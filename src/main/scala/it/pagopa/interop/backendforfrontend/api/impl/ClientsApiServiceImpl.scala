...
final case class ClientsApiServiceImpl(clientProcessService: ClientProcessService) extends ClientsApiService {
  ...
  override def deleteClient(
    ...
    val result: Future[Unit] = clientProcessService.deleteClient(clientId)
